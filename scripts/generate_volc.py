#!/usr/bin/env python3
"""
Generalized image generation with Volcengine Doubao, supports reference image style matching.
Usage:
python generate_volc.py --reference reference.jpg --prompt "your prompt" --count 4 --output ./output
"""
...
def main():
    parser = argparse.ArgumentParser(description='Generate images with consistent style from reference (Volcengine Doubao)')
